export const Msg = {
  ...
  CONTEST_ALREADY_EXISTS: `Contest already exists`,
  ...
  CONTEST_STARTED: `Contest started successfully`,
  CONTEST_ENDED: `Contest ended successfully`,
  CONTEST_JOINED: `Contest joined successfully`,
  CONTEST_LEFT: `Contest left successfully`,
  CONTEST_ALREADY_JOINED: `Contest already joined`,
  CONTEST_ALREADY_LEFT: `Contest already left`,
  CONTEST_NOT_STARTED: `Contest not started`,
  CONTEST_NOT_ENDED: `Contest not ended`,
  CONTEST_NOT_JOINED: `Contest not joined`,
  CONTEST_NOT_LEFT: `Contest not left`,
